...
class Router{
    ...
    /**Metodos que definem as rotas  */
    /** Metodo responsavel  por adicionar rota na classe  */
    private function  addRoute( $method,  $route,  $params =[] ){
        ...
        // print_r( $params );
        // echo '</pre>';
        // Estes dados que foram recebidos, agora tem de serem adicionados nas rotas 
